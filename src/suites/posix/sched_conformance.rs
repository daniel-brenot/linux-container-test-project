...
#[crate::lctp_test(suite = posix, full, expect = success, case = "yield, getscheduler, getpriority, and getaffinity can be queried together")]
...
#[crate::lctp_test(suite = posix, expect = soft, case = "setpriority to the current nice succeeds or is rejected")]
...
#[crate::lctp_test(suite = posix, full, expect = soft, case = "sched_setaffinity with the current mask succeeds or is rejected")]
